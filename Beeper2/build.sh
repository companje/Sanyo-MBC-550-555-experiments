prefix="0314. goto10-"
base=app-working-backup-wonderfull-days
...
WAV_OUTPUT=sweep.wav
# 
# -autoboot_script script.lua 
mame mbc55x -wavwrite $WAV_OUTPUT -flop1 "$img" -debug -debugscript autostart.txt -ramsize 256K -skip_gameinfo -window -nomaximize -resolution0 800x600 -prescale 2 -gamma 3 -contrast 1.5
