...
# ./mbc55xtest
mame mbc55x -autoboot_script script.lua -flop1 $img -debug -debugscript autostart.txt -ramsize 256K -skip_gameinfo -window -nomaximize -resolution0 800x600 -prescale 2 -gamma 3 -contrast 1.5
# cd -
